...
func scanBackend(s scanner) (domain.Backend, error) {
	var (
		...
		consoleUsername, consolePassword, newAPIRefresh, consoleAuthorization, consoleCheckinPath, channelURL, consoleCookie, consoleHeadersJSON, notes string
